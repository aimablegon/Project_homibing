				...
				<div class="g_postbox">
					<div class="gpo_text">
						<div class="gpo_ct">
							<div class="ct">
								<div class="ct_title">
									<span class="gtitle">호미빙티 차 선물세트</span>
								</div>
								<div class="ct_date">
									<span class="g_15">15-12-10</span>
								</div>
								<div class="ct_text">
									<p class="gmemo">
									연말연시 고마운 사람들께 감사의 마음을 전할때 호미빙티의 차 선물세트를 선물해 보세요.  
									<br/>
									<br/>
									</p>
									<p class="gmemo2">
									선물하시는 분의 마음이 오래 오래 간직할 수 있도록, 그리고 차를 보관하시는 내내 항상 신선함을 유지할 수 있도록 저희 호미빙티에서는 예쁜 케이스까지 준비되어 있습니다. 가격에 부담없이 하지만 정성이 가득한 호미빙티 선물세트, 지금 호미빙티 매장에서 판매하고 있습니다.
									</p>
								</div>
								<div class="ct_last">
									<span class="gmin_title">HOMIBING T GIFT TEA SET</span>
								</div>
							</div>
							<div class="ci_img">
