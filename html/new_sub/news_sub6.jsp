				...
				<div class="g_postbox">
					<div class="gpo_text">
						<div class="gpo_ct">
							<div class="ct">
								<div class="ct_title">
									<span class="gtitle">고급 디저트처럼 즐기는 빙수케익 2종 출시!</span>
								</div>
								<div class="ct_date">
								...
								<div class="ct_ttext">
									<p class="gmmemo">
									새롭게 출시된 ‘빙수 케익’ 2종은 호미빙T의 인기 메뉴인 초코빙수, 망고빙수를 좀 더 고급스럽게 디저트화한 메뉴로서 두 메뉴 모두 신선한 생 딸기가 기본 토핑으로 올라가 있습니다.
									<br/>
									망고 빙수케익은 망고의 달콤함과 딸기의 새콤함이 입안 가득 조화를 이뤄 여성 고객의 입맛을 확실히 사로 잡고 있으며, 초코 빙수케익은 빙수 테두리에 바삭한 초코 과자로 꾸며져서 빙수와 과자까지 함께 맛 볼 수 있어 달콤한 디저트를 맛보고 싶은 고객에게 큰 인기를 끌고 있습니다.
									</p>	
								</div>
								<div class="ct_last">
									<span class="gmmin_title">#ICE FLAKES CAKE</span>
								</div>
							</div>
							<div class="ci_img">
