				...
				<div class="g_postbox">
					<div class="gpo_text">
						<div class="gpo_ct">
							<div class="ct">
								<div class="ct_title">
									<span class="gtitle">호미빙티 차 이야기</span>
								</div>
								<div class="ct_date">
								...
								<div class="ct_text">
									<p class="gmemo">
									호미빙티에서 사용하는 녹차, 홍차, 자스민차는 각종 음료의 베이스와 티 자체의 맛과 향으로도 이미 많은 분들이 인정해 주시고 계십니다. 
									<br/>
									<br/>
									</p>
									<p class="gmemo2">
									 비밀은 바로 오리지날 대만산 제품을 제공함으로써 차 본연의 향이 상당히 부드러우면서도 은은하며 오래가는 특징이 있습니다. 오늘 호미빙티에서 한잔의 차로 느끼는 힐링타임, 즐겨보시기 바랍니다.
									</p>
								</div>
								<div class="ct_last">
									<span class="gmin_title">HOMIBING T TEA STORY</span>
								</div>
							</div>
							<div class="ci_img">
								<img src="/homibing/lib/images/hyein/gallery_list_view_4_1.jpg" alt="" alt="" />
								<img src="/homibing/lib/images/hyein/gallery_list_view_4_2.jpg" alt="" alt="" />
								<img src="/homibing/lib/images/hyein/gallery_list_view_4_3.jpg" alt="" alt="" />
